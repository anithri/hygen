...
describe('mergeHygenConfig', function () {
    describe('Basics', function () {
        it('should be a function', function () {
            expect(typeof mergeConfig_1.mergeConfig).toEqual('function');
        });
        // does it accept all of the various parameter signatures it needs
        // does it return the correct data
    });
    describe('mergeHygenConfig(stale: Record<string,any>, fresh: Record<string,any>): Record<string,any>', function () {
        it('should merge two object', function () {
            var stale = { a: 1 };
            var fresh = { b: 2 };
            var result = mergeConfig_1.mergeConfig(stale, fresh);
