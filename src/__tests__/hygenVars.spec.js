import {coerceArray, mergeArrays, mergeVars} from '../hygenVars'

describe('mergeVars(orig: HygenVars, addition: HygenVars): : HygenVars', () => {
  it('should be a function', () => {
    expect(typeof mergeVars).toEqual('function')
  })
})
